...
public class PatientData extends AppCompatActivity implements View.OnClickListener {
    ...
    public static SwitchCompat switch_1, switch_2;
            ...
            if(view instanceof SwitchCompat){
                ...
                switchCompat.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton cb, boolean on) {
                        ...
                        Log.e(LOG_TAG, "childnumber " + childnumber);
    ...
    *        i       newnumber     sensorreferredtotheswitch = i-2  --> this depends upon the order we have in the .xml file for the layout
                                                                        in practice in the overall layout the order is: sensor1; sensor2; switch1; switch2; sensor3; sensor4;switch3;switch4
    *        0           1               /
    *        1           2               /
    *        2           1               1
    *        3           2               2
    ...
    private void DeviceActivation(Activity activity){
        ...
        switch (DeviceSelection){
            ...
            case 9: //Environmental Monitor e IMUs
                redirectActivity(PatientData.this, IMUs_Environmental.class);
                break;
            ...
            case 11: //Environmental Monitor e IMUs e SPO2
                redirectActivity(PatientData.this, IMUs_Saturation_Environmental.class);
                break;
...
//QUESTI NON SERVONO PIU'
    public void onIMUpressed() {
        ...
        //set message
        builder.setMessage("Do you want to acquire data from IMUs and pulse oximeter together?\n\nIf NO, you will acquire data only from the IMUs.");
        //Positive yes button
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public void onpulseoxpressed() {
        ...
        builder.setTitle("Choose recording type");
        //set message
        builder.setMessage("Do you want to acquire data from IMUs and pulse oximeter together?\n\nIf NO, you will acquire data only from the pulse oximeter.");
        //Positive yes button
        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
